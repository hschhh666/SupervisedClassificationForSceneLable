...
def parse_option():
    ...
    opt.model_name = '{}_lr_{}_decay_{}_bsz_{}_featDim_{}_{}'.format(curTime, opt.learning_rate, opt.weight_decay, opt.batch_size, opt.feat_dim, opt.comment_info)
...
def set_model(args):
    ...
    model = MyAlexNetCMC(args.feat_dim, args.class_num)
